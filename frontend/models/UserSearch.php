...
/**
 * UserSearch represents the model behind the search form about `common\models\p\User`.
 */
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'superadmin', 'created_at', 'updated_at', 'email_confirmed', 'contratista_id'], 'integer'],
