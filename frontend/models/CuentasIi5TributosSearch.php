...
/**
 * CuentasIi5TributosSearch represents the model behind the search form about `common\models\c\CuentasIi5Tributos`.
 */
class CuentasIi5TributosSearch extends CuentasIi5Tributos
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'administracion_ajustada' => $this->administracion_ajustada,
            'ventas' => $this->ventas,
