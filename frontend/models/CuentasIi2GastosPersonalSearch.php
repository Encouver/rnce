...
/**
 * CuentasIi2GastosPersonalSearch represents the model behind the search form about `common\models\c\CuentasIi2GastosPersonal`.
 */
class CuentasIi2GastosPersonalSearch extends CuentasIi2GastosPersonal
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CuentasIi2GastosPersonal::find();
