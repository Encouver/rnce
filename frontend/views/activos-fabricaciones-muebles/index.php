...
<!--    <p>
    ...
    $dynagrid = DynaGrid::begin([
        ...
        'gridOptions'=>[
            ...
            'summary'=>'',
            'panel'=>[
                'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Activos - Frabricaciones Muebles</h3>',
        ...
        'options'=>['id'=>'dynagrid-fabricaciones-muebles'] // a unique identifier is important
    ]);
