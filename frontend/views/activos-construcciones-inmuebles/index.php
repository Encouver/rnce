...
/* @var $searchModel app\models\ActivosConstruccionesInmueblesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Activos Construcciones Inmuebles');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="activos-construcciones-inmuebles-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<!--    <p>
        <?/*= Html::a(Yii::t('app', 'Create Activos Construcciones Inmuebles'), ['create'], ['class' => 'btn btn-success']) */?>
    </p>-->
<!--
    <?/*= GridView::widget([
    ...
    $dynagrid = DynaGrid::begin([
        ...
        'gridOptions'=>[
            ...
            'summary'=>'',
            'panel'=>[
                'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Activos - Construcciones Inmuebles</h3>',
        ...
        'options'=>['id'=>'dynagrid-construcciones-inmuebles'] // a unique identifier is important
    ]);
