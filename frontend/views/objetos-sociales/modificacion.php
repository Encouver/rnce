...
<div class="objetos-sociales-index">
   ...
   <?php
    if(isset($documento) && $documento->objeto_social){
    ...
    ]);  if(!$searchModel->existeregistro() && $documento->objeto_social){ ?>
        ...
        <?= Html::a(Yii::t('app', 'Agregar Objeto Social'), ['create'], ['class' => 'btn btn-success']) ?>
         ...
         <?php }  }else{?>
            ...
            <div class="alert-warning alert fade in">
                ...
                <h4>No existe ningun procedimiento referente a modificacion del objeto social activo</h4>
