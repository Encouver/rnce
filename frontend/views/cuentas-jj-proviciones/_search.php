...
/* @var $model app\models\CuentasJjProvicionesSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="cuentas-jj-proviciones-search">
    ...
    <?= $form->field($model, 'importe_provisionado_periodo') ?>

    <?= $form->field($model, 'aplicacion_amortizacion') ?>
