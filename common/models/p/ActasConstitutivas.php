...
class ActasConstitutivas extends \common\components\BaseActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'denominacion_comercial_id' => Yii::t('app', 'Denominacion Comercial'),
            'duracion_empresa_id' => Yii::t('app', 'Duracion Empresa'),
            'objeto_social_id' => Yii::t('app', 'Objeto Social'),
            'razon_social_id' => Yii::t('app', 'Razon Social'),
            'cierre_ejercicio_id' => Yii::t('app', 'Cierre Ejercicio'),
            ...
            'domicilio_fiscal_id' => Yii::t('app', 'Domicilio Fiscal'),
            'domicilio_principal_id' => Yii::t('app', 'Domicilio Principal'),
            ...
            'modificacion_acta_id' => Yii::t('app', 'Modificacion Acta'),
