 ...
 *
 * @property SysMotivos $sysMotivo
 */
class DesincorporacionActivos extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(SysMotivos::className(), ['id' => 'sys_motivo_id']);
    }
}
