 ...
 * @property SysMetodosMedicion $sysMetodoMedicion
 */
class Mediciones extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['medicion_activo', 'aplica_deterioro', 'vinculado_proceso_productivo', 'vinculado_proceso_ventas', 'sys_status'], 'boolean'],
    ...
    {
        return $this->hasOne(SysMetodosMedicion::className(), ['id' => 'sys_metodo_medicion_id']);
    }
}
