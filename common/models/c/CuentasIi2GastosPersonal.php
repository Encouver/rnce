...
/**
 * This is the model class for table "cuentas.ii2_gastos_personal".
 *
 * @property integer $id
 * @property integer $concepto_id
 * @property string $administracion
 * @property integer $admin_metodo_id
 * @property string $administracion_ajustadas
 ...
 */
class CuentasIi2GastosPersonal extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cuentas.ii2_gastos_personal';
    }
    ...
    {
        return [
            [['concepto_id', 'administracion', 'admin_metodo_id', 'administracion_ajustadas', 'contratista_id', 'anho'], 'required'],
            ...
            [['anho'], 'string', 'max' => 100],
            [['concepto_id', 'contratista_id', 'anho'], 'unique', 'targetAttribute' => ['concepto_id', 'contratista_id', 'anho'], 'message' => 'The combination of Concepto ID, Contratista ID and Anho has already been taken.'],
            [['concepto_id', 'contratista_id', 'anho'], 'unique', 'targetAttribute' => ['concepto_id', 'contratista_id', 'anho'], 'message' => 'The combination of Concepto ID, Contratista ID and Anho has already been taken.']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'admin_metodo_id' => Yii::t('app', 'Admin Metodo'),
            'administracion_ajustadas' => Yii::t('app', 'Administracion Ajustadas'),
            'ventas' => Yii::t('app', 'Ventas'),
            'ventas_metodo_id' => Yii::t('app', 'Ventas Metodo'),
    ...
    public function getFormAttribs() {
        return [
            ...
            'concepto_id' => ['type'=>Form::INPUT_WIDGET,'widgetClass'=>Select2::classname(),'options'=>['data'=>ArrayHelper::map(CuentasSysConceptos::concepto('i4.2'),'id','nombre',function($model){ return $model->sysClasificacion->nombre;}),
