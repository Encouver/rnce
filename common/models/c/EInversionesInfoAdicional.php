 ...
 * @property integer $sys_tecnica_medicion_id
 ...
 *
 * @property EInversiones[] $eInversiones
 */
class EInversionesInfoAdicional extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['precio_adquisicion', 'gan_per', 'gan_per_ajustada', 'prima_descuento', 'cotiza_bolsa_valores', 'gtia_oblig_bancaria', 'sys_tecnica_medicion_id', 'deterioro'], 'required'],
            ...
            [['plazo', 'sys_tecnica_medicion_id', 'creado_por', 'actualizado_por'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sys_tecnica_medicion_id' => Yii::t('app', 'Sys Tecnica Medicion ID'),
     ...
     */
    public function getEInversiones()
    {
        return $this->hasMany(EInversiones::className(), ['e_inversion_info_adicional' => 'id']);
    }
}
