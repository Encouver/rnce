...
/**
 * This is the model class for table "cuentas.aa_tipos_garantias".
 *
 * @property integer $id
 ...
 */
class AaTiposGarantias extends \common\components\BaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'cuentas.aa_tipos_garantias';
    }
    ...
    {
        return $this->hasMany(AaObligacionesBancarias::className(), ['tipo_garantia_id' => 'id']);
    }
}
